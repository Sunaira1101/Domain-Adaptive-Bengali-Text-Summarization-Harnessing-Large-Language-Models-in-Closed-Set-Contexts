...
def scrape_bd_news_articles(article_urls):
    ...
    for article_url in article_urls:
        ...
        if response.status_code == 200:
            ...
            article_title_tag = soup.find('h1', class_='bbc-qa2lun e1p3vdyi0')
            ...
            article_text = ""
            article_text_tags = soup.find_all('p', class_='bbc-12k5sdr e17g058b0') 
            for tag in article_text_tags:
                article_text += tag.text.strip() + "\n"
            
            # Extract article summary (if available)
            article_summary_tag = soup.find('p', class_='bbc-12k5sdr e17g058b0')
...
if __name__ == "__main__":
    ...
    article_urls = read_article_urls_from_file('bbc_urls1.txt')
    ...
    if articles_info:
        ...
        with open('bbc_scraped1.csv', 'w', newline='', encoding='utf-8') as csvfile:
